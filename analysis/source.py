...
if __name__ == '__main__':
            ...
            user_input_key_string = raw_input('Enter key >= 16 bytes: ')
            user_input_key = bytearray(user_input_key_string)
...
#            user_input_key = bytearray(line)
            ...
            save_path = 'encrypted_' + image_file_name
            scipy.misc.imsave(save_path, SE)
            

            #### Storing TIndex Values for analysis #####
            tindex_f = open('t_index/'+user_input_key_string+'_tindex.txt','w')
            json.dump(TIndex_Array, tindex_f)
            tindex_f.close()
            ...
            save_path_d = 'decrypted_'+image_file_name
